...
export class TaskService {
  ...
  getLists(params?) {
    return this.webReqService.get('lists', params);
  }
  ...
  getTasks(listId: string, filters?) {
    return this.webReqService.get(`lists/${listId}/tasks`, filters);
  }
  ...
  getTasksSummary() {
    return this.webReqService.get('tasks-summary');
  }
